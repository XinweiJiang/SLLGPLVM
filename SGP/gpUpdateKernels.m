function model = gpUpdateKernels(model, Z, Z_u)
...
% 	gpUpdateKernels.m CVS version 1.3
% 	gpUpdateKernels.m SVN version 178
% 	last update 2009-01-08T13:49:20.000000Z
...
switch model.approx
 case 'ftc'
  ...
  model.K_uu = kernCompute(model.kern, Z);
