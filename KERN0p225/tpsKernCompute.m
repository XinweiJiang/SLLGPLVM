function [k, sk, n2] = tpsKernCompute(kern, x, x2)
...
% 	rbfKernCompute.m SVN version 375
% 	last update 2009-06-02T22:01:41.000000Z

if nargin < 3
  n2 = dist21(x, x);
  tt = [x'; ones(1,size(x,1))]'*[x'; ones(1,size(x,1))];
else
  n2 = dist21(x, x2);
  tt = [x'; ones(1,size(x,1))]'*[x2'; ones(1,size(x2,1))];
end
...
k = kern.variance*eye(size(x,1))+sk;
