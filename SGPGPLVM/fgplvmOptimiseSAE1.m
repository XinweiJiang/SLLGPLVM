function model = fgplvmOptimiseSAE1(model, display, iters);
...
for i = 1:nLoop
    params = optim('fgplvmObjectiveGradient1', [paramsL model.Z(:)'], options, model);
    startVal = 1;
    ...
    params = optim('gpObjectiveGradient1', [paramsR model.Z(:)'], options, model);
    startVal = 1;
    ...
    params = optim('fgplvmObjectiveGradient2', [paramsU model.Z(:)'], options, model);
    startVal = 1;
