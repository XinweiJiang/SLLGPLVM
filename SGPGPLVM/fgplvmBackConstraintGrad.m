function g = fgplvmBackConstraintGrad(model, gZ)
...
% 	fgplvmBackConstraintGrad.m CVS version 1.1
% 	fgplvmBackConstraintGrad.m SVN version 29
...
if isfield(model, 'back') & ~isempty(model.back)
  ...
  for i = 1:model.q
    g_modelParams = g_modelParams + g_w(:, :, i)'*gZ(:, i);
  end
  g = g_modelParams;
else
  % Do nothing
